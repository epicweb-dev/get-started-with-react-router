...
// 💣 remove the MarketingLayout import here
import { MarketingLayout } from './layout.tsx'

export function AboutRoute() {
	return (
		// 💣 remove the MarketingLayout component here
		// 💰 don't forget to remove the closing </MarketingLayout> tag below
		<MarketingLayout>
			<div className="flex h-full flex-col gap-4">
				...
				<div className="flex flex-col gap-4">
					...
					<p>
						...
						, but the version you're looking at now is for workshop purposes
						only.
					</p>
					<p>
