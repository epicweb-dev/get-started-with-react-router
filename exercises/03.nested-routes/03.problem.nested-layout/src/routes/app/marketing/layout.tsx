...
export function MarketingLayout() {
	return (
		// ⬇️ 🐨 Move this stuff into the AppLayout component ⬇️
		<div className="bg-background flex h-screen flex-col">
			...
			<div className="flex min-h-0 flex-1 flex-grow flex-col">
				{/* 🐨 Once you've move this to the AppLayout component, put the <Outlet /> here */}
				{/* ⬆️ 🐨 Move this stuff into the AppLayout component ⬆️ */}

				{/* ⬇️ 🐨 Keep this stuff in the MarketingLayout component ⬇️ */}
